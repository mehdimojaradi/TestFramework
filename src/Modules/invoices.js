...
const _INVOICE_NUMBER_LINK = "#invoice-list-tables > div:nth-child(2) > table > tbody:nth-child(2) > tr > td:nth-child(1) > a";
const _INVOICE_TITLE = "#area > div > h1";
const INVOICE_NO_ID = "#invoice_number_id";
const SEARCH_BUTTON = '#ui-tabs-1 > div > fieldset > form > div > input[type="submit"]:nth-child(2)';
//#endregion
